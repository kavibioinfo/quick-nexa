        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="text-slate-500 text-xs md:text-sm mt-1 font-medium">
              विविध स्थानिक व्यवसायांसाठी बनवलेले अप्रतिम नमुने. त्यांच्या आकर्षक डिझाईन आणि युझर एक्सपिरियन्सवरून अंदाज लावा.
            </p>
          </div>
 
          {/* 👑 SPECIAL VIP ENTERPRISE MEDICAL SUITE BANNER (CROWN JEWEL) 👑 */}
          <div className="max-w-7xl mx-auto mb-12 bg-gradient-to-br from-slate-900 via-slate-950 to-blue-950 rounded-2xl p-6 md:p-10 border border-blue-500/30 shadow-2xl relative overflow-hidden group">
            <div className="absolute top-0 right-0 bg-blue-600 text-white px-6 py-2 rounded-bl-2xl font-black text-[10px] tracking-widest uppercase flex items-center gap-1.5 shadow-md">
              <Sparkles className="w-3.5 h-3.5 text-amber-300" /> ENTERPRISE FLAGSHIP PRODUCT
            </div>
            
            <div className="absolute -top-24 -left-24 w-96 h-96 bg-[radial-gradient(circle,_rgba(59,130,246,0.15)_0%,transparent_70%)] blur-3xl pointer-events-none" />
 
            <div className="grid lg:grid-cols-12 gap-8 items-center relative z-10">
              <div className="lg:col-span-7">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 mb-4">
                  <Activity className="w-3.5 h-3.5 text-cyan-400 animate-pulse" />
                  <span className="text-[10px] font-black tracking-widest text-cyan-400 uppercase">Fully Dynamic Automation Suite</span>
                </div>
                <h3 className="text-xl md:text-3xl font-black text-white uppercase tracking-tight mb-4 leading-snug">
                  AyushNexa Healthcare <br className="hidden md:block"/>
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400">Super Speciality Network</span>
                </h3>
                <p className="text-slate-400 text-xs md:text-sm leading-relaxed mb-6 font-medium max-w-2xl">
                  मोठ्या हॉस्पिटल्स, क्लिनिक्स आणि लॅब्ससाठी डिझाइन केलेली नेक्स्ट-जनरेशन आर्किटेक्चर सिस्टीम. यामध्ये एका बाजूला रुग्णांसाठी प्रिमियम विंग फ्रंट-एंड फ्रंटिंग आहे, आणि दुसऱ्या बाजूला <strong className="text-white">Supabase PostgreSQL Cloud Cluster</strong> वर चालणारा अल्ट्रा-फास्ट मॅनेजमेंट डॅशबोर्ड आहे.
                </p>
 
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs font-black uppercase text-slate-300 tracking-wider">
                  <div className="flex items-center gap-2"><CheckCircle size={14} className="text-cyan-400" /> Supabase Real-Time EHR Database</div>
                  <div className="flex items-center gap-2"><CheckCircle size={14} className="text-cyan-400" /> Live Patient & OPD Monitoring</div>
                  <div className="flex items-center gap-2"><CheckCircle size={14} className="text-cyan-400" /> Pharmacy Inventory Telemetry</div>
                  <div className="flex items-center gap-2"><CheckCircle size={14} className="text-cyan-400" /> Enterprise-Grade Data Security</div>
                </div>
              </div>
 
              <div className="lg:col-span-5 flex flex-col gap-4 w-full sm:p-4 bg-slate-950/40 border border-slate-800 rounded-xl p-5 shadow-2xl">
                <div className="text-center md:text-left border-b border-slate-800 pb-3 mb-1">
                  <span className="text-[10px] font-black tracking-widest text-slate-500 uppercase block">Launch Your Medical Brand</span>
                  <span className="text-sm font-bold text-slate-300 mt-1 block">Experience True Complete Automation</span>
                </div>
 
                {/* Masterpiece 1: Hospital Website Front-end */}
                <a
                  href="https://premiumdoctors.ayushnexa.com/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full flex items-center justify-between p-4 rounded-xl border border-slate-800 bg-slate-900/60 hover:bg-blue-600 hover:border-blue-600 text-white transition-all duration-200 group/item shadow-md cursor-pointer"
                >
                  <div className="flex items-center gap-3.5">
                    <div className="p-2.5 rounded-lg bg-blue-500/10 border border-blue-500/20 text-blue-400 group-hover/item:bg-white/10 group-hover/item:text-white transition-colors">
                      <Stethoscope size={18} />
                    </div>
                    <div className="text-left">
                      <div className="font-black text-xs uppercase tracking-wider">1. View Hospital Front End</div>
                      <div className="text-[10px] text-slate-500 group-hover/item:text-blue-100 transition-colors font-medium">Luxury UI Experience for Patients</div>
                    </div>
                  </div>
                  <ArrowUpRight size={16} className="text-slate-500 group-hover/item:text-white transition-colors" />
                </a>
 
                {/* Masterpiece 2: Hospital Cloud Dashboard */}
                <a
                  href="https://premium-hospital-dashboard.ayushnexa.com/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full flex items-center justify-between p-4 rounded-xl border border-cyan-500/30 bg-cyan-950/20 hover:bg-cyan-600 hover:border-cyan-600 text-white transition-all duration-200 group/item shadow-md cursor-pointer"
                >
                  <div className="flex items-center gap-3.5">
                    <div className="p-2.5 rounded-lg bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 group-hover/item:bg-white/10 group-hover/item:text-white transition-colors">
                      <LayoutDashboard size={18} />
                    </div>
                    <div className="text-left">
                      <div className="font-black text-xs uppercase tracking-wider text-cyan-400 group-hover/item:text-white">2. Access Live Cloud Dashboard</div>
                      <div className="text-[10px] text-slate-500 group-hover/item:text-cyan-100 transition-colors font-medium">Supabase Multi-Table Database Engine</div>
                    </div>
                  </div>
                  <ArrowUpRight size={16} className="text-slate-500 group-hover/item:text-white transition-colors" />
                </a>
                ...
                <button
                  onClick={() => {
                    const hospitalText = `नमस्कार AyushNexa Solutions! \n\nमी तुमची Healthcare Enterprise (Hospital Website + Live Dashboard) सिस्टीम पाहिली, खरोखरच कडक आहे. मला आमच्या हॉस्पिटल/क्लिनिकसाठी ही संपूर्ण ऑटोमेशन सिस्टीम ठेवावी आहे. कृपया डेमो आणि बजेट कस्टमायझेशनसाठी संपर्क साधा. 🏥⚡`;
                    handleWhatsAppRedirect(hospitalText);
                  }}
                  className="w-full bg-slate-100 hover:bg-white text-slate-950 font-black py-3.5 rounded-xl text-[11px] tracking-widest uppercase transition-all shadow-md flex items-center justify-center gap-2 mt-1 cursor-pointer"
                >
                  <span>REQUEST DISCOVERY CALL</span> <Phone size={12} className="text-blue-600" />
                </button>
              </div>
            </div>
          </div>
          
          {/* STANDARD BUSINESS DEMOS (THE OLD 4 CARDS) */}
        ...
        <div className="max-w-4xl mx-auto bg-white border border-neutral-200 p-6 md:p-10 rounded-2xl grid lg:grid-cols-12 gap-8 items-center shadow-md relative overflow-hidden">
          ...
          <div className="lg:col-span-7">
            ...
            <p className="text-slate-600 text-xs md:text-sm leading-relaxed mb-6 font-medium">
              हा कोणताही mammal वर्डप्रेस टेंपलेट नाही. आम्ही स्वतः कस्टमाईज केलेल्या Next.js कोडसह तयार करतो.
          ...
          <div className="lg:col-span-5 bg-slate-50 border border-neutral-200 p-6 md:p-8 rounded-xl text-center shadow-inner w-full">
            ...
            <span className="text-dash font-black bg-blue-100 text-blue-700 border border-blue-200 px-4 py-1 rounded-full inline-block mt-3 mb-6 uppercase tracking-wider">
              Saves Over 73% Instantly
            </span>
 
            <button
              onClick={() => {
                const templateText = `नमस्कार AyushNexa Solutions! \n\nमला तुमच्या Premium Digital Growth Pack (₹३,९९९) OFFER मध्ये रस आहे. माझ्या व्यवसायासाठी नवीन वेबसाईट आणि WhatsApp Automation सुरू करायची आहे. कृपया लवकरात लवकर संपर्क करा आणि प्रक्रिया सुरू करा. ✨`;
